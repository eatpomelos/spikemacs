...
(let (;; Upstream theme color
  ...
  (custom-theme-set-faces
   ...
   ;; 设置不同等级标题的大小，有点问题
   `(org-level-1 ((t (:height 1.3 :weight normal :foreground ,spk-mint-darkblue))))
   `(org-level-2 ((t (:height 1.2 :weight normal :foreground ,spk-mint-red))))
   `(org-level-3 ((t (:height 1.1 :weight normal :foreground ,spk-mint-violetred))))
   `(org-level-4 ((t (:height 1.0 :weight normal :foreground ,spk-mint-yellow))))
   `(org-level-5 ((t (:height 1.0 :weight normal :foreground ,spk-mint-blue))))
   `(org-level-6 ((t (:height 1.0 :weight normal :foreground ,spk-mint-bamboo))))
   `(org-level-7 ((t (:height 1.0 :weight normal :foreground ,spk-mint-darkgreen))))
   `(org-level-8 ((t (:height 1.0 :weight normal :foreground ,spk-mint-orange))))
