...
;; 暂时来说，dracula已经够好了，暂时的想法是将这个主题设置成一个亮色主题
...
(let (;; Upstream theme color
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((t (:foreground ,spk-mint-blue))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,spk-mint-blue))))
   `(font-lock-keyword-face ((t (:foreground ,spk-mint-pink))))
   `(font-lock-string-face ((t (:foreground ,spk-mint-violetred))))
   `(font-lock-function-name-face ((t (:foreground ,spk-mint-green))))
   ...
   ;; linum 
   `(linum ((t (:background ,spk-mint-moon))))
   `(line-number ((t (:background ,spk-mint-lightblue))))
   ...
   `(org-level-2 ((t (:weight normal :foreground ,spk-mint-darkpurple))))
   ...
   `(org-level-6 ((t (:weight normal :foreground ,spk-mint-skyblue))))
   `(org-level-7 ((t (:weight normal :foreground ,spk-mint-bamboo))))
   `(org-level-8 ((t (:weight normal :foreground ,spk-mint-bamboo))))

   ;; dashborad face 暂时不考虑，这里使用原来的默认配置
   ;; `(dashboard-heading ((t (:foreground ,spk-mint-purple))))

   ;; magit设置，现在有些默认设置看不清字

   ;; company 设置
   `(company-echo-common ((t (:foreground ,spk-mint-bg :background ,spk-mint-fg))))
   `(company-tooltip ((t (:foreground ,spk-mint-fg :background ,spk-mint-moon))))
   ;; 补全提示栏设置
   `(company-scrollbar-bg ((t (:background ,spk-mint-green))))
